...
public class DefaultPaths {
  ...
  public static final String DEFAULT_REGEXNER_RULES = "edu/stanford/nlp/models/kbp/english/regexner_caseless.tab";
  ...
  public static final String DEFAULT_KBP_REGEXNER_CASED = "edu/stanford/nlp/models/kbp/english/regexner_cased.tab";
  public static final String DEFAULT_KBP_REGEXNER_CASELESS = "edu/stanford/nlp/models/kbp/english/regexner_caseless.tab";
  ...
  public static final String DEFAULT_KBP_TOKENSREGEX_NER_SETTINGS =
          "ignorecase=true,validpospattern=^(NN|JJ).*,edu/stanford/nlp/models/kbp/english/regexner_caseless.tab;" +
                  "edu/stanford/nlp/models/kbp/english/regexner_cased.tab";
